...
public class PriceParser {
    ...
    private List<CrawlDataHelper.Article> articles;

    public PriceParser(List<CrawlDataHelper.Article> articles) {
        ...
        for (CrawlDataHelper.Article article : articles) {
            asyncHelper.addTask(new SingleTask(article) {
                ...
                public Object doJob(Object[] args) {
                    CrawlDataHelper.Article item = (CrawlDataHelper.Article) args[0];
